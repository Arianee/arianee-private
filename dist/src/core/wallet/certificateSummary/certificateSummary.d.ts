...
export declare class CertificateEventsSummary implements CertificateEvents {
    transfer: any[];
    arianeeEvents: any[];
    readonly all: any[];
}
...
export declare type ConsolidatedIssuerRequest = ConsolidatedIssuerRequestInterface | boolean;
export declare type ConsolidatedContentRequest = ConsolidatedContentRequestInterface | boolean;
