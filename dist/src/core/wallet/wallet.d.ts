...
export declare class ArianeeWallet {
    private container;
    private _account;
    private _mnemonic;
    constructor(configuration: ClassicConfiguration, arianeeConfig: ArianeeConfig);
    private registerSingletons;
    readonly globalConfiguration: any;
    setCustomSendTransaction(send: (transaction: Transaction) => Promise<any>): ArianeeWallet;
    setCustomCall(call: (transaction: Transaction, data: TransactionObject<any>) => Promise<any>): ArianeeWallet;
    setCustomSign(sign: (data: string) => Promise<{
        message: string;
        messageHash: string;
        signature: string;
    }>): ArianeeWallet;
    ...
    readonly mnemnonic: string;
    readonly web3: any;
    readonly configuration: ArianeeConfig;
    readonly methods: {
        ...
        createCertificate: (data: import("../../models/transaction-parameters").hydrateTokenParameters) => Promise<{
            [key: string]: any;
            passphrase: string; /**
             * @deprecated use address instead
             */
        ...
        createCertificatesBatch: (datas: import("../../models/transaction-parameters").hydrateTokenParameters[]) => Promise<unknown>;
        createAndStoreCertificate: (data: import("../../models/transaction-parameters").hydrateTokenParameters, urlOfRPCServer?: string) => Promise<{
            [key: string]: any;
            passphrase: string;
            certificateId: any;
            deepLink: string;
        ...
        getIdentity: (address: string, issuerQuery?: import("./certificateSummary/certificateSummary").ConsolidatedIssuerRequest) => Promise<import("../../models").IdentitySummary<any>>;
    ...
    readonly arianeeMethods: {
        ...
        credit: {
            ...
            types: () => import("../../models").creditTypeEnum[];
        };
        identity: {
            fetch: (objParams: {
                address: string;
                query?: import("./certificateSummary/certificateSummary").ConsolidatedIssuerRequest;
        ...
        certificate: {
            ...
            creation: {
                create: (data: import("../../models/transaction-parameters").hydrateTokenParameters) => Promise<{
                    [key: string]: any;
                    passphrase: string; /**
                     * @deprecated use address instead
                     */
                ...
                createAndStore: (objParams: {
                    data: import("../../models/transaction-parameters").hydrateTokenParameters;
                ...
                batch: (objParams: {
                    datas: import("../../models/transaction-parameters").hydrateTokenParameters[];
                }) => Promise<unknown>;
            };
            arianeeAccessToken: {
                create: (objParams: {
    ...
    readonly requestPoa: () => Promise<any>;
    readonly requestAria: () => Promise<any>;
    readonly account: any;
    readonly walletservice: WalletService;
    readonly contracts: ContractService;
    customWatch: (watchParameters: WatchParameter) => EventEmitter<string | symbol, any>;
    readonly watch: EventEmitter;
    setDefaultQuery(value: ConsolidatedCertificateRequest): this;
}
